...
export class UpdateMarketComponent implements OnInit {
    ...
    updatemarketform() {
        ...
        this.userid=1;
        this.image="1.png"
        this.Service.updatemarket(this.prosaid,this.titleForm,this.userid,this.balance,this.image,this.field_id,this.lat,this.lng,this.addressForm,this.phoneForm,this.mobileForm,this.Status,this.rate,this.order_count,this.picks,this.detailsForm).subscribe(
            data => {
                console.log(data)
                this.image = null;
                this.form = this.fb.group({
