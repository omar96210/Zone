...
@Component({
    moduleId: module.id,
    selector: 'AddChoiceslist-cmp',
    templateUrl: 'AddChoiceslist.component.html'
})

export class AddChoiceslistComponent implements OnInit {
    selectedFile: File;
    url: any;
    ...
    Addchoicesform() {
        ...
        this.Service.Addchoices(this.NameForm,this.priceForm,this.optionsSectionlistid,this.image).subscribe(
            data => {
                console.log(data)
                this.image = null;
                this.form = this.fb.group({
